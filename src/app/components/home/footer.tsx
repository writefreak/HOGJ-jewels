...
export default function Footer() {
  return (
    <footer className="bg-[#f9f5f2] border-t border-[#76492E]/10 px-6 pt-16 pb-8">
      <div className="max-w-6xl mx-auto">
        {/* Large editorial brand name */}
        <div className="border-b border-[#76492E]/10 pb-10 mb-10 overflow-hidden">
          <p className="font-playfair text-[13vw] md:text-[10vw] font-semibold leading-none text-[#76492E]/10 select-none tracking-tight whitespace-nowrap">
            Heart of Gold
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-[1fr_auto_auto] gap-10 md:gap-24 pb-12 border-b border-[#76492E]/10">
          {/* Tagline + socials */}
          <div className="col-span-2 md:col-span-1 flex flex-col gap-6 max-w-xs">
            <p className="font-playfair text-[15px] text-[#1a1a1a]/60 leading-relaxed italic">
              "Every piece carries the weight of a moment worth remembering."
            </p>
